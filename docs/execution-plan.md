...
| M2 — End-to-end demo query | Pending | Execute a query through core using the demo adapter |
| M3 — Batch output and automation | Pending | Stream exact results in all initial machine formats |
| M4 — Real Trino execution | Pending | Execute and cancel native queries on Trino |
